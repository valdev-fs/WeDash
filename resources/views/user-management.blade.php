                ...
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                        <form action="{{ route('user-management.storeDepartment') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="name_department">Department Name</label>
                                <input type="text" name="name_department" id="name_department" class="form-control" required>
                            </div>
            ...
            <div class="col-md-6 mt-3 mt-md-0">
                <div class="card card-custom">
                    ...
                    <div class="card-body">
                                ...
                                @foreach ($departments as $department)
                                    <tr>
                                        ...
                                        <td class="action-buttons">
                                            <button class="btn btn-info btn-icon btn-edit" data-id="{{ $department->id }}" data-name="{{ $department->name_department }}">
                                                <i class="fas fa-edit"></i>
                                            </button>
                                            <form action="{{ route('user-management.deleteDepartment', $department->id) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                        ...
                        {{ $departments->links('vendor.pagination.bootstrap-4') }} <!-- Pagination links with custom view -->
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editDepartmentForm" method="POST">
                            ...
                            <div class="form-group">
                                <label for="edit_name_department">Department Name</label>
                                <input type="text" name="name_department" id="edit_name_department" class="form-control" required>
                            </div>
